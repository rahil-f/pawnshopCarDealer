                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <div className="mt-2">
                                        <input onChange={(e) => setPlate(e.target.value)} id="plate" name="plate" type="text" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                            </div>
                        </div>
